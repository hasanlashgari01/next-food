...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed">
      ...
      <div
        className={twMerge(
          "fixed inset-x-1/2 bottom-0 z-20 flex h-fit w-dvw translate-x-1/2 flex-col rounded-t-[36px] bg-slate-100 p-8 font-IranYekan transition-transform max-sm:h-[50dvh] max-sm:justify-evenly sm:inset-y-1/2 sm:max-w-lg sm:-translate-y-1/2 sm:rounded-2xl lg:max-w-2xl lg:rounded-2xl lg:py-14 dark:bg-gray-800",
