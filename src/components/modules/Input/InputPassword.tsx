...
const InputPassword: React.FC<PasswordProps> = ({ type, onType, message, children, label = "رمز عبور" }) => {
  ...
  return (
    <label htmlFor="password" className="text-xs sm:text-sm">
      <div className="mb-2 flex justify-between px-4">
        <span className="shrink-0 font-semibold text-primary-900 dark:text-primary-300">{label}</span>
