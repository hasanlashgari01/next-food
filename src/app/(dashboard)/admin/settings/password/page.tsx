    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="font-IranYekan">
        <div className="grid grid-cols-6 gap-6">
          <div className="col-span-6 grid gap-4 sm:col-span-4 xl:col-span-3">
            <InputPassword
            ...
            <button type="submit" disabled={!isValid} className="add-btn mt-4 w-fit">
              تغییر رمز عبور
            </button>
          </div>
          <ul className="col-span-6 h-fit list-decimal rounded-lg border border-red-500 p-5 sm:col-span-4 xl:col-span-3 xl:mr-16">
            <h3>رمز عبور صحیح شامل </h3>
            <div className="my-2 pr-8 child:text-xs/6 child:text-red-500 md:child:text-sm/7 xl:child:text-base/8">
              <li>حداقل ۸ کاراکتر</li>
              <li>حداکثر ۳۲ کاراکتر</li>
